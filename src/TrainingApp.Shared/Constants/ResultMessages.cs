namespace TrainingApp.Shared.Constants
{
    public static class ResultMessages
    {
        public static readonly string SuccessMessage = "Request completed successfully.";
        public static readonly string FailMessage = "Request failed.";
